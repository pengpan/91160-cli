...
set BASE_DIR=%~dp0
if not exist "%BASE_DIR%\config.properties" echo Please run init.bat first! & EXIT /B 1

set "JAVA_OPT=%JAVA_OPT% -Xms512m -Xmx512m -Xmn256m"
set "JAVA_OPT=%JAVA_OPT% -Dfile.encoding=utf-8"
set "JAVA_OPT=%JAVA_OPT% -jar %BASE_DIR%\91160-cli.jar"
set "JAVA_OPT=%JAVA_OPT% register"
set "JAVA_OPT=%JAVA_OPT% -c config.properties"
